...
// Import and re-export types from llm_rotation.ts
import type {
    Message,
    ModelConfiguration,
    ApiKeys,
...
// ===== OpenAI API Compatible Request/Response Interfaces =====
...
export class ApiError extends Error {
    ...
    static keysExhausted(provider: string, keyStatuses: ApiKeyStatus[], lastError?: string): ApiError {
        return new ApiError(
            `All ${provider} API keys failed. Last error: ${lastError || 'Unknown error'}`,
            'api_error',
            'keys_exhausted',
            502,
            {
...
// ===== API Key Status and Monitoring Types =====
